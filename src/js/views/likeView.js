...
export const toggleLikeMenu = (numLikes) => {
    document.querySelector(".liked__field").style.visibility = numLikes > 0 ? "visible" : "hidden";
}

export const toggleLikeBtn = (uId, active) => {
    const elem = document.querySelector(`#pokemon__Id--${uId}.pokemon__liked svg use`)
    if (elem) elem.setAttribute("xlink:href", `./img/icons/sprites.svg#icon-like${active ? "" : "_dislike"}`)
}
...
<li id="like__link-${like.uId}" class="liked__link">
    ...
    <img class="liked__img"src="../img/pokemonImages/${genName(like.id, like.uId, like.form)}.png" alt="pokemon">
    ...
    document.querySelector(".liked__list").insertAdjacentHTML("beforeend", htmlMarkup);
}
